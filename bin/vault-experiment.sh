...
az vm open-port --port 8200 --resource-group $groupName --name "${VMName}-1"
az vm open-port --port 8201 --resource-group $groupName --name "${VMName}-1"
...
az vm open-port --port 8200 --resource-group $groupName --name "${VMName}-2"
az vm open-port --port 8201 --resource-group $groupName --name "${VMName}-2"
